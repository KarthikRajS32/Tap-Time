<footer class="bg-[#02066F] text-white w-full pt-10 mt-4 pb-18 sm:pb-24">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row flex-wrap justify-evenly items-start gap-12 text-center md:text-left">
